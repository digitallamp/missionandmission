function initialize() {
    ...
    // Multiple Markers
    var markers = [
	    ['Bhopal Office, India', 23.237307,77.43936],
        ['Gwalior Office, India', 26.215250,78.176698],
		['Indore Office, India', 22.745482, 75.894275],
        ['Ujjain Office, India', 23.175981,75.791908]
    ...
    var infoWindowContent = [
	   ['<div class="info_content">' +
        '<h3>MbbsAbroadStudy</h3>' +
        '<p>Sr.MIG 1,Gokuldham Society,Housing Board Building,Near Chetak Bridge,Gautam Nagar , BHOPAL (M.P.) INDIA 462023</p>' +
        '</div>'],
        ['<div class="info_content">' +
        '<h3>MbbsAbroadStudy</h3>' +
        '<p>K-29 Gandhi Nagar ,GWALIOR,M.P. 474002 INDIA</p>' + '</div>'],
        ['<div class="info_content">' +
        '<h3>MbbsAbroadStudy</h3>' +
        '<p>146,Orbit mall Near C21 mall ,A.B.Road ,Vijay Nagar,INDORE (M.P.) 452016 INDIA </p>' +
        '</div>'],
        ['<div class="info_content">' +
        '<h3>MbbsAbroadStudy</h3>' +
        '<p>99/2 , Varruchi Marg ,Near AK Building ,Freeganj,UJJAIN,(M.P.)456001 INDIA</p>' +
        '</div>']
    ];
